...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-array_models_Permission"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.nameDescriptionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-models_Permission"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-array_models_Role"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-models_Role"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/admin/roles/{name}/permissions": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.grantPermissionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/api/admin/roles/{name}/permissions/{permission_name}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/auth/api/admin/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by email/username substring",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by status: active, locked, or suspended",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-service_ListUsersResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/admin/users/{id}/audit-logs": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by event type, e.g. login.failed",
                        "name": "event_type",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-service_ListAuditLogsResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/admin/users/{id}/history": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/auth/api/admin/users/{id}/reactivate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.grantRoleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/api/admin/users/{id}/roles/{role_name}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/auth/api/admin/users/{id}/suspend": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-models_Token"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/email-change/confirm": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Email change token (GET) -- or pass 'token' in a POST body instead",
                        "name": "token",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.RequestEmailChange"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-service_LoginResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/mfa/confirm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "MFA Confirm Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.mfaConfirmRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-handler_mfaConfirmResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-service_MFAEnrollResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/api/mfa/login/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "MFA Login Verify Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.mfaLoginVerifyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/api/passwordless/login": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Magic Link Token (GET) -- or pass 'token' in a POST body instead",
                        "name": "token",
                        "in": "query"
                    }
                ],
        ...
        "/auth/api/sessions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ApiResponse-array_service_SessionInfo"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Session record ID to keep (e.g. the caller's current session)",
                        "name": "except",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.RequestSMSOTP"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/api/sms-otp/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SMS OTP Verify Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.RequestSMSOTPVerify"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.ApiResponse-array_models_Role": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handler.ApiResponse-array_service_AuthHistoryEntry": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.AuthHistoryEntry"
                    }
                },
                "error": {
                    "type": "string"
        ...
        "handler.ApiResponse-array_service_SessionInfo": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handler.ApiResponse-handler_mfaConfirmResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.ApiResponse-models_Role": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.Role"
        ...
        "handler.ApiResponse-models_Token": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.ApiResponse-service_ListAuditLogsResult": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.ApiResponse-service_ListUsersResult": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/service.ListUsersResult"
                },
                "error": {
                    "type": "string"
                }
        ...
        "handler.ApiResponse-service_LoginResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.ApiResponse-service_MFAEnrollResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/service.MFAEnrollResponse"
                },
                "error": {
                    "type": "string"
                }
        ...
        "handler.grantPermissionRequest": {
            "type": "object",
            "properties": {
                "permission_name": {
                    "type": "string"
        ...
        "handler.nameDescriptionRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "models.Token": {
            ...
            "properties": {
                ...
                "token_type": {
                    "description": "access, refresh, passwordless",
                    "type": "string"
                },
                "user_id": {
                    "type": "string"
