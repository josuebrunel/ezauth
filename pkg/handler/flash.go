...
func (h *Handler) GetFlash(ctx context.Context, key string) string {
...
func (h *Handler) GetErrorMessage(ctx context.Context) string {
...
func (h *Handler) GetSuccessMessage(ctx context.Context) string {
