...
var (
	...
	ErrInvalidLimitParam            = errors.New("invalid limit; expected a non-negative integer")
	ErrInvalidOffsetParam           = errors.New("invalid offset; expected a non-negative integer")
)
