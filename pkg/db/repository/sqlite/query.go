...
func (q *SqliteQuerier) QueryUserSetEmailVerified(ctx context.Context, userID string, verified bool) bob.Query {
	qm := []bob.Mod[*dialect.UpdateQuery]{
		um.Table(models.TableUser),
...
func (q *SqliteQuerier) QueryUserSetPhoneVerified(ctx context.Context, userID string, verified bool) bob.Query {
	return sqlite.Update(
		um.Table(models.TableUser),
...
// QueryUserUpdate -- see its doc comment for why.
func (q *SqliteQuerier) QueryUserSetMFAEnabled(ctx context.Context, userID string, enabled bool) bob.Query {
	return sqlite.Update(
		um.Table(models.TableUser),
...
func (q *SqliteQuerier) QueryTokenRevokeAllByUserIDAndType(ctx context.Context, userID, tokenType string) bob.Query {
	return sqlite.Update(
		um.Table(models.TableToken),
		um.SetCol(models.ColumnRevoked).ToArg(true),
		um.Where(sqlite.Quote(models.ColumnUserID).EQ(sqlite.Arg(userID))),
		um.Where(sqlite.Quote(models.ColumnTokenType).EQ(sqlite.Arg(tokenType))),
	)
}
