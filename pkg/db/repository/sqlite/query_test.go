...
func TestSqliteQuerier_UserOperations(t *testing.T) {
...
func TestSqliteQuerier_TokenOperations(t *testing.T) {
	querier := &SqliteQuerier{}
	ctx := context.Background()
	now := time.Now()
...
func TestSqliteQuerier_AuditLogOperations(t *testing.T) {
	querier := &SqliteQuerier{}
	ctx := context.Background()
