...
replace github.com/josuebrunel/ezauth => ../../

require (
	github.com/go-chi/chi/v5 v5.2.4
	github.com/josuebrunel/ezauth v0.3.1
)
...
require (
	...
	github.com/josuebrunel/gopkg/xenv v0.0.1 // indirect
	github.com/josuebrunel/gopkg/xlog v0.0.1 // indirect
